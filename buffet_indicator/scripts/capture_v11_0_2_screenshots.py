"""v11.0.2 — re-capture the 6 derived spread screenshots after fixes."""
...
OUT_DIR = Path("outputs/screenshots/v11_0_2")
DESKTOP = (1920, 1080)
...
def capture() -> dict:
    ...
    with sync_playwright() as p:
        ...
        for name, tab in TARGETS:
            ...
            page.evaluate("(t) => window.localStorage.setItem('mv_active_tab', t)", tab)
            page.goto(
