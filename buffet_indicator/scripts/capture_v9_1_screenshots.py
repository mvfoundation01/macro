...
Usage::
    ...
    python scripts/capture_v9_1_screenshots.py               # all tabs
    python scripts/capture_v9_1_screenshots.py v9_1_mvci.png # one tab
...
TABS = [
    ("v9_1_overview.png", None, (1440, 900), "svg"),
    ("v9_1_mvci.png", "mvci", (1440, 900), "#hero-chart-mvci svg"),
    ("v9_1_buffett.png", "buffett", (1440, 900), "#hero-chart-buffett svg"),
    ("v9_1_cape.png", "cape", (1440, 900), "#hero-chart-cape svg"),
    ("v9_1_crestmont.png", "crestmont", (1440, 900), "#hero-chart-crestmont svg"),
    ("v9_1_qratio.png", "qratio", (1440, 900), "#hero-chart-qratio svg"),
    ("v9_1_ey_deficit.png", "ey_deficit", (1440, 900), "#hero-chart-ey_deficit svg"),
    (
        "v9_1_mean_reversion.png",
        "mean_reversion",
        (1440, 900),
        "#hero-chart-mean-reversion svg",
    ),
    ("v9_1_diagnostics.png", "diagnostics", (1440, 900), "svg"),
    ("v9_1_mobile.png", None, (360, 800), "svg"),
]
